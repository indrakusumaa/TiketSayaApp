...
public class TicketDetail extends AppCompatActivity {
    TextView title_ticket,loc_ticket,photo_spot_ticket,wifi_ticket,festival_ticket,short_desc_ticket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loc_ticket = findViewById(R.id.loc_ticket);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                loc_ticket.setText(dataSnapshot.child("lokasi").getValue().toString());
        ...
        btn_buy_ticket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotocekout = new Intent(TicketDetail.this,TicketCheckOut.class);
                gotocekout.putExtra("jenis_tiket",jenis_tiket_baru);
                startActivity(gotocekout);
            }
        });
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gobackhome = new Intent(TicketDetail.this,HomeAct.class);
